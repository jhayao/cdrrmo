...
class PieChart2State extends State<PieChartSample2> {
  ...
  Future countTotal() async{
    ...
    querySnapshot.docs.forEach((element) {
      ...
      setState(() {
        maleCount += double.parse(element.get('male'));
        femaleCount += double.parse(element.get('female'));
        totalCount += double.parse(element.get('total'));
      });
      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            ...
            title:  '${maleCount.toStringAsFixed(0)}\n${malePercentage.toStringAsFixed(0)}%',
            radius: radius,
