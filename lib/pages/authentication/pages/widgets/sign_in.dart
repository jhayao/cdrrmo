...
class _SignInState extends State<SignIn> {
  ...
  void _toggleSignInButton() async{
    ...
    setState(() {
      loginEmailController.text.isEmpty ? emailValidate = true : emailValidate = false;
      loginPasswordController.text.isEmpty ? passwordValidate  = true : passwordValidate = false;
    });

    if(emailValidate!=true && passwordValidate !=true)
    {
      dynamic result = await _auth.signInEmailPassword(loginEmailController.text, loginPasswordController.text);
      setState(() {
        loading= true;
      });
      ...
      if (result.error){
        ...
        CustomSnackBar(context,  Text('Login: ' + result.toString()));
        print(result.uid);
        CoolAlert.show(
          context: context,
