                          ...
                          if (snapshot.data == null) {
                            ...
                            return ListView.builder(
                                ...
                                itemBuilder: (context, i) {
                                  ...
                                  docId = data.id;
                                  if (snapshot.hasData) {
                                    return _accident(i,docId,
                                        deviceWidth, data["name"], data["image"],
                                        data["status"],data["date_posted"],data["latitude"],data["longitude"],userType,data["month"]);
                                  }
                                  return Center(
...
//Doctor card
  Widget _accident(int counter,String uid,double width,String name,String url,String status,String _date,String lat,String long,String userType,String month) {
